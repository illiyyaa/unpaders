    ...
    <div class="container-fluid main">  
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="{{ url('/') }}"><img src="/img/logo unpaders.png" width="150" height="40"></a>
                    <button type="button" class="btn navbar-toggle" data-toggle="collapse" data-target="#myNavbar" style="background-color: transparent; border:0; color:#ffffff">BAHASA</button>
                <div>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active car-height">  
                <img src="/img/11.jpeg" class="d-block w-100 h-100" alt="gambar">
            ...
            <div class="carousel-item car-height">
                <img src="/img/13.jpeg" class="d-block w-100  h-100" alt="gambar">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item car-height">
                <img src="/img/12.jpeg" class="d-block w-100  h-100" alt="gambar">
                <div class="carousel-caption d-none d-md-block">
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <div class="top-right">
                    <button class="btn btn-style"><a data-toggle="modal" data-target="#mylogin" href="#">Masuk</a></button>
                    <button class="btn btn-style"><a data-toggle="modal" data-target="#mydaftar" href="#">Daftar</a></button>             
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 ">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><a href="{{url('/detail')}}">Ini Tiga Rekomendasi Konferensi Covid-19 IKA Unpad</a></li>
            ...
            <ul class="list-unstyled mb-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 mb-4 mb-md-0 taag">
                        <a href="{{url('/aktual')}}" class="tag">AKTUAL</a>
                        <h6><a href="{{url('/detail1')}}">Irawati Hermawan: Penanganan Covid-19 Perlu Kolaborasi</a></h6> 
        ...
        <div class="modal-dialog">
            ...
            <h4 class="modal-title" style="color: #FDB000;">Daftar</h4>
        ...
        <div id="mydaftar1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        ...
        <div class="modal-dialog" style="border-radius:20px;">
            ...
            <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title" style="color: #FDB000;">Masuk</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>    
            </div>
            <div class="modal-body">
            <form>
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-10">
                            <button type="button" class="btn btn-style" data-dismiss="modal" style="margin-left: 40px; margin-top: 20px; width:100%">
                            <a onclick="$('#mylogin').modal('hide');$('#mylogin1').modal('show');" href='#' style="color:#FFFFFF; text-decoration:none;">Masuk Sebagai Alumni</a></button>
                        </div>
                    </div>
		        </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-10">
                            <button type="button" class="btn btn-style" data-dismiss="modal" style="margin-left: 40px; margin-top: 20px; width:100%">
                            <a onclick="$('#mylogin').modal('hide');$('#mylogin2').modal('show');" href='#'  style="color:##FDB000; text-decoration:none;">Masuk Sebagai Umum</a></button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <a onclick="$('#mylogin').modal('hide');$('#mydaftar').modal('show');" href='#' style="color:#8A8A8A; text-decoration:none;">Daftar</a></button>  
            </div>
            </div>  
        </div>
        </div>
       
        <div id="mylogin1" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
            <button type="button" class="btn btn-style" ><a href="{{ url('/artikel')}}" style="text-decoration:none; color: #FFFFFF;">Masuk</a></button>  
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
            <button type="button" class="btn btn-style"><a href="{{url('/belanjaumum')}}">Masuk</a></button>  
            </div>
            </div>
        </div>
        </div>
