...
<div class="card-deck" style="padding:50px; width:70rem; ">
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title"><a data-toggle="modal" data-target="#mybeli" href="#mybeli3">Kaos Unpaders</a></h5>
...
<div class="card-deck" style="padding:50px; width:70rem; ">
    <div class="card">
        ...
        <img src="/img/kaos.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h5 class="card-title"><a data-toggle="modal" data-target="#mybeli3" href="#">Kaos Unpaders</a></h5>
            <h4 class="card-text">Rp. 110.000,-</h4>
        </div>
        </div>
        <div class="card">
